...
import static com.sw.automate.config.EnvironmentInitializer.Props.SPRING_PROFILES_ACTIVE;
...
public class EnvironmentInitializer {
    ...
    interface Props {
        ...
        String MMEG_GLYPHES_OPTIMIZER_DEV_DIR = "config.dir";
    ...
    interface Resources {
        String MMEG_GLYPHES_OPTIMIZER_CONFIG = "config/";
    }
    ...
    private static class FolderConfig {
        ...
        FolderConfig(final String rootDir) {
            ...
            mainManagerConfigLocation = String.format(FOLDER_STRUCT, rootDir, Resources.MMEG_GLYPHES_OPTIMIZER_CONFIG, "configuration");
            mainBootConfigLocation = String.format(FOLDER_STRUCT, rootDir, Resources.MMEG_GLYPHES_OPTIMIZER_CONFIG, "configuration");
        }
    }
    ...
    public void setUp(final String componentId, final String appId) {
        String mmegGlyphesOptimizerDevDir = System.getProperty(Props.MMEG_GLYPHES_OPTIMIZER_DEV_DIR);
        System.setProperty("javax.xml.parsers.DocumentBuilderFactory", "com.sun.org.apache.xerces.internal.jaxp.DocumentBuilderFactoryImpl");
        // On est en environnement de développement simplifié
        if (mmegGlyphesOptimizerDevDir != null) {
            ...
            String runningDesc = "";
            mmegGlyphesOptimizerDevDir = fixPathAsDir(mmegGlyphesOptimizerDevDir);
            FolderConfig config = new FolderConfig(mmegGlyphesOptimizerDevDir);
    ...
    private static String fixPathAsDir(String mmegGlyphesOptimizerDevDir) {
        mmegGlyphesOptimizerDevDir = mmegGlyphesOptimizerDevDir.replace('\\', '/');
        if (!mmegGlyphesOptimizerDevDir.endsWith("/")) {
            mmegGlyphesOptimizerDevDir += '/';
        }
        return mmegGlyphesOptimizerDevDir;
    }
