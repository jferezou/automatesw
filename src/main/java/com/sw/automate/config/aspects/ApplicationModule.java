...
import com.sw.automate.exception.FonctionnelleException;
import com.sw.automate.exception.ServiceExceptionHandler;
import com.sw.automate.exception.TechniqueException;
...
public class ApplicationModule {
        ...
        /**
         * handler des exceptions de service
         */
         ...
         */
        public ApplicationModule(final String applicationId, ServiceExceptionHandler serviceExceptionHandler) {
        ...
        public class Context {
             ...
             */
            public <V> V execute(final Call<V> callable) throws FonctionnelleException, TechniqueException {
                ...
                try {
                    ...
                    try {
                        ...
                        throw serviceExceptionHandler.handleFonctionnelleException(e, techLogger);
                    } catch (Throwable e) {
                        throw serviceExceptionHandler.handleTechniqueException(e, techLogger);
                    }
                } finally {
                    completeExecute();
                }
            ...
            public Response execute(final ProceedingJoinPoint pjp) {
                Response response;
                try {
                    response = execute(() -> {
                    ...
                    response = serviceExceptionHandler.asErrorResponse(e);
