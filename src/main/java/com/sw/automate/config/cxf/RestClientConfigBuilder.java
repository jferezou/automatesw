package com.sw.automate.config.cxf;
...
import static com.sw.automate.config.cxf.CxfUtils.getHttpConduit;
import static com.sw.automate.config.cxf.CxfUtils.getRestConfig;
